...
type NoteRepository interface {
	...
	UpdateTags(ctx context.Context, noteID uint64, note []string) error // fully updates all tags
	AddTags(ctx context.Context, noteID uint64, note []string) error    // extends existing tags
}
